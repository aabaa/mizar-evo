...
| records は span または source-request 主位置、`BuildSnapshotId`、freshness state を明示的に持つ。 | `failure_record.rs`。 | `tests/failure_record.rs`、`tests/aggregator.rs`、`tests/determinism.rs`。 | Covered。 |
