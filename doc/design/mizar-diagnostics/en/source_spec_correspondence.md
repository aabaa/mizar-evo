...
| Records carry span or source-request primary locations, `BuildSnapshotId`, and freshness state. | `failure_record.rs`. | `tests/failure_record.rs`, `tests/aggregator.rs`, `tests/determinism.rs`. | Covered. |
