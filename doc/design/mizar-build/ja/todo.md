...
6. **モジュール索引の構築。** [x]
   ...
   - 完了した build-side slice: `ModuleIndex`、package/namespace/module entry、
     ...
     provider accessor。2026-06-18 に `mizar-resolve` task 7 を確認したところ、まだ open
     であり `crates/mizar-resolve` も存在しない。そのため resolver stub replacement と
     resolver-fixture parity は外部 dependency gap として残す。
