...
追加する。cache validation は cache-aware scheduling task と `mizar-cache` へ deferred
のままである。scheduler record が cache hit、skipped work、artifact record を proof
authority へ昇格することはない。
