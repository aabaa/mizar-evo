...
| 2 | done | pending self-hash | Spec/test/full/source-doc reviews: no blocking/high/medium findings after fixes. | `git diff --check`; `git diff --cached --check` | Spec: `cache_key.md`. |
