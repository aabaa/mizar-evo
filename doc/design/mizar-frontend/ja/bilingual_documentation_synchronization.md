...
- モジュールとタスク状態は同期済みである。task 1-23 は完了済みであり、
  follow-up task 24 は未着手のままである。
...
task 21、task 22、task 23 はその後完了した。既存の未着手 follow-up は次のとおり。
