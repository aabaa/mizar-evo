...
task 48-77 は crate plan、TODO、source/spec audit、corpus traceability で追跡する
...
forward local-attribute reserve type expression の対応する boundary を追加する。
これらは original score を変更せず、AST-wide extraction、CoreIr/ControlFlowIr/VC、
