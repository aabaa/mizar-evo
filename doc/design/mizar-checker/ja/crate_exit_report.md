...
task 48-83 は crate plan、TODO、source/spec audit、corpus traceability で追跡する
...
imported structure `R` だけを対応する provenance/type-head bridge へ昇格する。
これらは original score を変更せず、imported module AST extraction、positive
imported structure/mode elaboration、AST-wide extraction、CoreIr/ControlFlowIr/VC、
proof payload promotion を主張しない。
