...
まで `checker.type.external.mode_expansion_payload` で fail closed する。task 52 はさらに、
...
mode expansion や existential / base-shape evidence を捏造すること、symbol head に
source attribute を付けること、CoreIr / ControlFlowIr / VC / proof execution を主張する
ことは許可しない。
