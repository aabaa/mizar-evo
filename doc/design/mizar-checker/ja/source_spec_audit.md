...
attributed builtin head を missing-evidence diagnostic へ、task 55/56/57/58/59/60/61/62/63/64 外の same-module local
...
うえで同じ missing attributed-type evidence-query diagnostic へ運ぶ。
