...
attributed builtin head を missing-evidence diagnostic へ、task 55/56/57/58/59 外の same-module local
...
missing evidence-query diagnostic へ運ぶ。
