...
attributed builtin head を missing-evidence diagnostic へ、task 55/56/57/58/59/60/61 外の same-module local
...
同じ missing evidence-query diagnostic へ運ぶ。
