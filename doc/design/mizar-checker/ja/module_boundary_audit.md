...
| `src/typed_ast.rs` | 4659 | typed AST data model | `typed_ast.md` | no | no | Task-253/254/255/256/257 installとmutually exclusive Task-248/258A/258B1/258B2/258B3 ownershipを含むcohesive owner。 |
...
| `src/source_statement.rs` | 14045 | syntax-free source statement producer | `source_statement.md` | no | no | cohesiveなTask-258A/258B1/258B2/258B3/258B3N/258B3M1 statement/local-reference/witness/witness-name transaction、resolver/binding/lower provenance、subtree validation、rendering、paired typed/final install、corruption matrix。split不要。 |
...
| `src/resolved_typed_ast.rs` | 7201 | final resolved typed AST assembly | `resolved_typed_ast.md` | no | no | Task-251/252/253/254/255/256/257/258A/258B1/258B2/258B3/258B3N/258B3M1 clone-preserving handoffとsemantic coexistence guardを含むcohesive final projection module。 |
