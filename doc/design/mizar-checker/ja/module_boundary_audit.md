...
| `src/source_statement.rs` | 9812 | syntax-free source statement producer | `source_statement.md` | no | no | cohesiveなTask-258A/258B1/258B2/258B3 statement/local-reference/witness transaction、resolver/binding/lower provenance、subtree validation、rendering、paired typed/final install、corruption matrix。split不要。 |
...
| `src/resolved_typed_ast.rs` | 7195 | final resolved typed AST assembly | `resolved_typed_ast.md` | no | no | Task-251/252/253/254/255/256/257/258A/258B1/258B2/258B3 clone-preserving handoffとsemantic coexistence guardを含むcohesive final projection module。 |
