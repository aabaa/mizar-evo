...
| `src/typed_ast.rs` | 4660 | typed AST data model | `typed_ast.md` | no | no | Large but cohesive typed-AST tables, ids, validation, rendering, tests, Task-253/254/255/256/257 installation checks, and mutually exclusive Task-248/258A/258B1/258B2/258B3/258B3N/258B3M1/258B3M2A ownership; monitor ergonomics after downstream use. |
...
| `src/source_statement.rs` | 15746 | syntax-free source statement producer | `source_statement.md` | no | no | Cohesive Task-258A/258B1/258B2/258B3/258B3N/258B3M1/258B3M2A statement, local-reference, witness, witness-name, and numeral-witness transactions, resolver/binding/lower provenance, subtree validation, rendering, paired typed/final installation, and corruption matrices; no split required. |
...
| `src/resolved_typed_ast.rs` | 7202 | final resolved typed AST assembly | `resolved_typed_ast.md` | no | no | Cohesive final projection module, including Task-251/252/253/254/255/256/257/258A/258B1/258B2/258B3/258B3N/258B3M1/258B3M2A clone-preserving handoffs and semantic coexistence guards; no behavior-neutral split required. |
