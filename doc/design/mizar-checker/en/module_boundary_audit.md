...
|---|---:|---|---|---|---|---|
| `src/lib.rs` | 46 | crate boundary and public module exports | `00.crate_plan.md` and `source_spec_audit.md` | no | no | Keep as the crate root; it exports the documented syntax-free formula-composition, predicate-definition, functor-definition, and source-statement modules. |
| `src/typed_ast.rs` | 5172 | typed AST data model | `typed_ast.md` | no | no | Large but cohesive typed-AST tables, ids, validation, rendering, tests, Task-253/254/255/256/257 installation checks, the mutually isolated Task-259/260 atomic handoff/obligation transactions, and mutually exclusive Task-248/258A/258B1/258B2/258B3/258B3N/258B3M1/258B3M2A/258B3M2B1/258B3M2B2A/258B3M2B2B1A/258B3M2B2B1B1/258B3M2B2B2A/258B3M2B2B2B/258B3M2B2B2C/258B3M2B2B3A/258B3M2B2B3B/258B3M2B2B3C/258B3M2B2B3D/258B3M2B2B3E/258B4A/258B4B/258B4C/258B5A/258B5B ownership; monitor ergonomics after downstream use. |
...
| `tests/lint_policy.rs` | 1897 | cross-cutting policy and audit guards | `source_spec_audit.md`, `bilingual_sync_audit.md`, and `module_boundary_audit.md` | no | no | Large support test but intentionally centralizes repository-policy guardrails, including Task-259/260 module/spec/public-enum coverage and the unchanged production syntax boundary; no split required for task 34. |
| `tests/support/source_functor_definition_unit.rs` | 3782 | test-only Task-260 unit-test support | `source_functor_definition.md` and this audit | no | no | Keep as a non-integration child-module body. It constructs exact lower handoffs and opaque resolver identities without adding production syntax imports, lint exceptions, public resolver API, or semantic ownership. |
