...
| `tests/support/source_property_implementation_unit.rs` | 2152 | test-only Task-264 unit-test support | `source_property_implementation.md` and this audit | no | no | Non-integration child support for exact equals/means construction, carrier-identity corruption, nonempty-baseline transactionality, final replay, orphan/extra rejection, and actual Task-259 isolation. |
