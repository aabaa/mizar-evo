...
| `src/typed_ast.rs` | 4110 | typed AST data model | `typed_ast.md` | no | no | Large but cohesive typed-AST tables, ids, validation, rendering, tests, bidirectional Task-253/254/255/256 installation checks, Task-257A one-shot installation, and Task-257B1 combined installation; monitor ergonomics after downstream use. |
...
| `src/source_composite_formula.rs` | 2913 | syntax-free source composite-formula/binder producer | `source_composite_formula.md` | no | no | Cohesive Task-257A tables plus the exact Task-257B1 profile discriminator, binding extension, validation, rendering, install checks, and corruption tests; no split required. |
| `src/source_formula_composition.rs` | 1475 | syntax-free cross-family formula composition producer | `source_formula_composition.md` | no | no | Cohesive Task-257B1 atomic-edge/bound-use association, dependency fingerprints, deterministic rendering, and corruption tests; no split required. |
...
| `src/source_set_term.rs` | 5547 | syntax-free source set-term producer | `source_set_term.md` | no | no | Cohesive Task-255 six-table association, cross-family ownership/fingerprint validation, deterministic rendering, install checks, and corruption tests; no split required. |
...
| `src/resolved_typed_ast.rs` | 6949 | final resolved typed AST assembly | `resolved_typed_ast.md` | no | no | Cohesive final projection module, including Task-251/252/253/254/255/256/257A/257B1 clone-preserving handoffs; no behavior-neutral split required. |
