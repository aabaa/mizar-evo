...
| `src/resolved_typed_ast.rs` | 7635 | final resolved typed AST assembly | `resolved_typed_ast.md` | no | no | Cohesive final projection module, including clone-preserving Task-259--263 handoffs and mutual-exclusion guards; no behavior-neutral split required. |
...
| `tests/lint_policy.rs` | 1921 | cross-cutting policy and audit guards | `source_spec_audit.md`, `bilingual_sync_audit.md`, and `module_boundary_audit.md` | no | no | Centralized policy guardrails include Task-259--263 module/spec/public-enum coverage and the unchanged production syntax boundary. |
