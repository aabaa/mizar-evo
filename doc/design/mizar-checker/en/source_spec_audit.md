...
bare builtin reserve heads; active fail slices also carry same-module
attributed builtin heads to the missing-evidence diagnostic and same-module
local mode heads to the missing mode-expansion diagnostic, and same-module
local structure heads, including attributed local structure heads, to the
missing evidence-query diagnostic; task 54 also carries attributed
same-module local mode heads to the missing mode-expansion diagnostic. This is
...
real mode expansion, terms, formulas, overloads, CoreIr,
