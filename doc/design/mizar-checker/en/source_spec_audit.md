...
Task 98 addendum: the active `mizar-test` type-elaboration runner observes the
imported predicate/functor theorem formula source `theorem
ImportedPredicateFunctorPayloadBoundary: 1 divides (1 ++ 2);` after parser and
resolver execution and reports
`type_elaboration.external_dependency.ast_payload_extraction`. This credits only
the source-derived imported predicate/functor term-formula extraction-gap
boundary for Chapters 11, 12, 13, 14, and 16. It does not claim imported module
AST extraction, imported predicate/functor semantic payloads, checker
term/formula payload extraction, term inference, formula checking, recorded
facts, theorem acceptance, a dedicated `formula_statement` runner, CoreIr,
ControlFlowIr, VC, or proof payload coverage.

Task 100 addendum: the active `mizar-test` type-elaboration runner observes the
builtin membership theorem formula source `theorem BuiltinMembershipPayloadBoundary: 1 in 1;`
after parser and resolver execution and reports
`type_elaboration.external_dependency.ast_payload_extraction`. This credits
only the source-derived builtin membership term-formula extraction-gap boundary
for Chapters 13, 14, and 16. It does not claim checker term/formula payload
...
Task 101 addendum: the active `mizar-test` type-elaboration runner observes the
builtin inequality theorem formula source `theorem BuiltinInequalityPayloadBoundary: 1 <> 2;`
after parser and resolver execution and reports
`type_elaboration.external_dependency.ast_payload_extraction`. This credits
only the source-derived builtin inequality term-formula extraction-gap boundary
for Chapters 13, 14, and 16. It does not claim checker term/formula payload
extraction, inequality desugaring or equality semantic checking, formula
...
Task 102 addendum: the active `mizar-test` type-elaboration runner observes the
builtin type-assertion theorem formula source `theorem BuiltinTypeAssertionPayloadBoundary: 1 is set;`
after parser and resolver execution and reports
`type_elaboration.external_dependency.ast_payload_extraction`. This credits
only the source-derived builtin type-assertion term-formula extraction-gap
boundary for Chapters 13, 14, and 16. It does not claim checker term/formula
payload extraction, type-assertion type payload extraction, term inference,
type-assertion semantic checking, formula checking, recorded facts, theorem
acceptance, a dedicated `formula_statement` runner, CoreIr, ControlFlowIr, VC,
or proof payload coverage.

Task 103 addendum: the active `mizar-test` type-elaboration runner observes the
imported attribute assertion theorem formula source
`import parser.type_fixtures; theorem ImportedAttributeAssertionPayloadBoundary: 1 is empty;`
after parser and resolver execution and reports
`type_elaboration.external_dependency.ast_payload_extraction`. This credits
only the source-derived imported attribute assertion formula extraction-gap
boundary for Chapters 6, 11, 12, 13, 14, and 16. It does not claim checker
...
extraction for theorem formulas, a dedicated `formula_statement` runner,
CoreIr, ControlFlowIr, VC, or proof payload coverage.

Task 104 addendum: the active `mizar-test` type-elaboration runner observes the
attribute-level `non empty` imported attribute assertion theorem formula source
`import parser.type_fixtures; theorem ImportedNonEmptyAttributeAssertionPayloadBoundary: 1 is non empty;`
after parser and resolver execution and reports
`type_elaboration.external_dependency.ast_payload_extraction`. This credits
only the source-derived attribute-level `non empty` imported attribute
assertion formula extraction-gap boundary for Chapters 6, 11, 12, 13, 14, and
16. It does not claim checker term/formula payload extraction, imported
...
formula checking, recorded facts, theorem acceptance, imported module AST
extraction, checker `AttributeInput` payload extraction for theorem formulas,
a dedicated `formula_statement` runner, CoreIr, ControlFlowIr, VC, or proof
payload coverage.

Task 105 addendum: the active `mizar-test` type-elaboration runner observes the
set-enumeration theorem formula source
`theorem SetEnumerationPayloadBoundary: {1, 2} = {1, 2};` after parser and
resolver execution and reports
`type_elaboration.external_dependency.ast_payload_extraction`. This credits
only the source-derived set-enumeration theorem formula extraction-gap boundary
for Chapters 13, 14, and 16. It does not claim checker set-enumeration term
payload extraction, term/formula payload extraction, term inference,
equality/formula checking, recorded facts, theorem acceptance, a dedicated
`formula_statement` runner, CoreIr, ControlFlowIr, VC, or proof payload
coverage.

Task 99 addendum: the active `mizar-test` type-elaboration runner observes the
formula connective/quantifier theorem source `theorem
FormulaConnectiveQuantifierPayloadBoundary: contradiction implies for x being
set holds not contradiction;` after parser and resolver execution and reports
`type_elaboration.external_dependency.ast_payload_extraction`. This credits
only the source-derived Chapter 14 connective/quantifier formula extraction-gap
boundary inside a theorem declaration. It does not claim formula payload
extraction, quantifier binder/context payloads, formula checking, recorded
facts, theorem acceptance, a dedicated `formula_statement` runner, CoreIr,
ControlFlowIr, VC, or proof payload coverage.
