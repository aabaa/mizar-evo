...
checker shell handoff. It does not claim formula constants, child-formula graph
payloads, quantifier binder/context payloads, formula checking, recorded facts,
theorem acceptance, a dedicated `formula_statement` runner, CoreIr,
ControlFlowIr, VC, or proof payload coverage.
