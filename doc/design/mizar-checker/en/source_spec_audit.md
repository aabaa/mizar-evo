...
local mode heads to the missing mode-expansion diagnostic. This is not a new
checker raw-syntax dependency and does not close the AST-wide
source-to-checker gaps for non-builtin declarations, imported symbols,
attribute or mode arguments, structures, terms, formulas, overloads, CoreIr,
