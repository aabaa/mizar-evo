...
missing evidence-query diagnostic. This is not a new checker raw-syntax
...
arguments, attributed local mode heads, structure base-shape/full
attributed-type existential evidence, terms, formulas, overloads, CoreIr,
