...
- [~] [Step 5C.12: unbounded templates](../../task_contracts/en/STEP5C12-UNBOUNDED-TEMPLATES.md); explicit identity-functor and predicate-formal checking; structure-bound source checking remains pending.
