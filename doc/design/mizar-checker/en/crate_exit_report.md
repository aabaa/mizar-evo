...
48-76 are post-closeout continuation tasks tracked in the crate plan, TODO,
...
heads, and task 76 adds the matching boundary for forward local-structure
reserve heads. These additions do not change the original score or claim
AST-wide extraction, CoreIr/ControlFlowIr/VC, or proof payload promotion.
