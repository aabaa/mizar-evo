...
## Task 269SDT Binding-Type Overlay

Under the [central Task-269SDT contract](../../task_contracts/en/269SDT.md),
the validated SDC environment remains `3 contexts / 2 bindings / 0
diagnostics`. Only binding 1 changes from `BindingTypeSite::Missing` to
