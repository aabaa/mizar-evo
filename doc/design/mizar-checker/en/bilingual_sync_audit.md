...
| `source_formula_composition.md` | `../ja/source_formula_composition.md` | `../en/source_formula_composition.md` | Task-257B1/B2/B3 and Task-257C2 plus completed C4A/C4B and implementation-complete C4C3 authority/boundary, composite/condition/predicate-chain composition, exact-F5 binding/use families, nested binder/use identity transport, dependency validation, exact consumers, exclusions, public enum policy | none |
