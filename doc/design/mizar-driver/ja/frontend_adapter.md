...
公開 E0220–E0224 draft には未登録の組込 registry descriptor が別途必要。全体の `CompilerDriver::submit` は後段 service 不足を dispatch 前に検査するため、直接の service と scheduler fixture で限定経路を確認しても全体 build 実行は主張しない。E0225 と完全な workspace summary は後続とする。
