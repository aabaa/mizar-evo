...
8. **driver のコア。** [ ]
   ...
   - テスト: batch-oriented fixture workspace で session capture、
     ...
     synthetic output なしの classified gap 報告、modeled scheduler fixture 上の
     deterministic scheduler submission / phase ordering を検証する。real frontend-service
     fixture は D-006 の owner seam が存在した後にだけ要求される。
