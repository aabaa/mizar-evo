# Frozen Log: mizar-checker Source/Spec Audit Archived Sections (2026)
...
Moved verbatim from `doc/design/mizar-checker/en/source_spec_audit.md` on 2026-09-02
(compaction batch CPT-08, rules in
...
[../mizar-checker/en/source_spec_audit.md](../mizar-checker/en/source_spec_audit.md). The authoritative per-task
...
[payload_family_decomposition.md](../mizar-checker/en/payload_family_decomposition.md). It does
...
[`source_mode_definition.md`](../mizar-checker/en/source_mode_definition.md) owns the future
...
owner is [source_template_type_parameter_association](../mizar-checker/en/source_template_type_parameter_association.md#task-277b-l-template-type-parameter-association), not 277A's `source_template`.
