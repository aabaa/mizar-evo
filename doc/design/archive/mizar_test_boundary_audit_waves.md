# Frozen Log: mizar-test Module-Boundary Audit Archived Sections (2026)
...
Moved verbatim from `doc/design/mizar-test/en/module_boundary_audit.md` on
2026-09-02 (compaction batch CPT-05, rules in
...
bodies exclude those lines. Frozen: do not extend; the live audit authority
is [../mizar-test/en/module_boundary_audit.md](../mizar-test/en/module_boundary_audit.md).
...
> [../ja/module_boundary_audit.md](../mizar-test/ja/module_boundary_audit.md).
...
refactor. [harness.md](../mizar-test/en/harness.md), [minimal_crate.md](../mizar-test/en/minimal_crate.md),
[expectation_schema.md](../mizar-test/en/expectation_schema.md), and
