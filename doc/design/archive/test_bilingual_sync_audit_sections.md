# Frozen Log: mizar-test Bilingual Sync Audit Archived Sections (2026)
...
Moved verbatim from `doc/design/mizar-test/en/bilingual_sync_audit.md` on 2026-09-02
(compaction batch CPT-15, rules in
...
[../mizar-test/en/bilingual_sync_audit.md](../mizar-test/en/bilingual_sync_audit.md). The authoritative per-task
...
> [../ja/bilingual_sync_audit.md](../mizar-test/ja/bilingual_sync_audit.md).
