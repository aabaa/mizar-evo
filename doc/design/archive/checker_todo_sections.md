# Frozen Log: mizar-checker TODO Archived Bodies (2026)
...
Moved verbatim from `doc/design/mizar-checker/en/todo.md` on 2026-09-02
(compaction batch CPT-02, rules in
...
authority is [../mizar-checker/en/todo.md](../mizar-checker/en/todo.md).
This archive preserves only what the TODO itself carried: the
authoritative per-task detail is the paired task contract under
[../task_contracts/en/](../task_contracts/en/), which may hold facts
(e.g. owner partitions) that a JA companion carried but the EN TODO did
not.
...
32. **Source/spec correspondence audit.** [x]
    ...
    - Completed by task 32: [source_spec_audit.md](../mizar-checker/en/source_spec_audit.md)
...
33. **Bilingual documentation sync audit.** [x]
    ...
    - Completed by task 33: [bilingual_sync_audit.md](../mizar-checker/en/bilingual_sync_audit.md)
...
34. **Module-boundary refactor gate.** [x]
    ...
    - Deps: 33. Spec: this TODO,
      ...
      specs.
    - Completed by task 34: [module_boundary_audit.md](../mizar-checker/en/module_boundary_audit.md)
