...
| SCA-004 | `external_dependency_gap` | `mizar-resolve` + `mizar-diagnostics` | Extend beyond the adopted E0022-only import continuation only through real producer integration; allocate remaining name/label/cycle descriptors with that adoption task; do not invent placeholder adapters. |
