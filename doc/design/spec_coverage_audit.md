...
| SCA-004 | `external_dependency_gap` | `mizar-resolve` + `mizar-diagnostics` | Complete source-bound resolver diagnostic adoption using allocated import descriptors; allocate remaining name/label/cycle descriptors only with a real producer adoption task; do not invent placeholder adapters. |
