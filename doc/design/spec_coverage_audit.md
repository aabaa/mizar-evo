...
| `07.modes.md` | Parser/syntax and checker type-normalization docs cover mode syntax and unfolding boundaries. Checker task 35 pins constructor arguments as not being a property-value source, and task 39 pins overlapping property implementations as requiring coherence, both with inactive semantic corpus and traceability; task 39 also records deferred parser coverage for property implementation syntax. | partial | Active property-implementation parser support/fixtures, resolver/checker signature payloads, positive property implementation payloads, accepted coherence status, and source-to-checker extraction remain required for full source coverage. |
