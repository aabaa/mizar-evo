...
| 262 | parent: type-elaboration source-extraction leaf を移動。Tasks 262A-262D 後も open。 |
...
| 262E | 次: bounded reserve declaration-segmentation/local-mode traversal/expansion family を移動し、Task 262C の temporary helper visibility 3個を narrow。 |
