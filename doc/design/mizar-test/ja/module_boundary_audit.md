...
| `src/runner/type_elaboration/type_assertion_routes.rs` | reserved-variable type-assertion/asserted-head configとthin source/detail/test route wrapperのactive owner。Tasks 263ZE-263ZGがlocal-mode long-chain builtin/same-mode/immediate-radix asserted-head routeを所有。 |
