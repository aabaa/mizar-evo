...
| `src/runner/type_elaboration/type_assertion_routes.rs` | reserved-variable type-assertion/asserted-head configとthin source/detail/test route wrapperのactive owner。Tasks 263ZE-263ZTがlocal-mode long-chain builtin/same-mode/immediate-radix/two-hop/three-hop/four-hop/five-hop/six-hop routeすべてとlocal-object-mode builtin reserved-variable type-assertion、same-mode/immediate-radix/six-/five-/four-/three-/two-hop asserted-head routeを所有。 |
