...
`5e41e4dbfcc303322c246a612de61926a628957a168589b45864d0a5070bb07e` と
`c0c2b80f8b4e6c84cd25d77573fda722c4d1846fed168cd4a478781cdb42775e`
を維持する。Task 262H0 は完了し、Task 262H が next。test intent、coverage
...
| source extraction | exact source-shape recognition と real AST/resolver payload construction | syntax/resolver input から checker input | Tasks 262A-262B で common source-AST primitive/projection、Task 262D で shared exact fixture-import projection を private `type_elaboration/source_ast.rs`、Tasks 262C/262E で reserve type-expression/symbol projection、declaration segmentation、local-mode expansion を private `type_elaboration/source_reserve.rs`、Tasks 262F-262G で standalone formula-constant/shared exact numeral projection を private `type_elaboration/source_formula.rs` へ移動済み。他の formula extraction と保持 caller は後続 Task 262 subtask まで `runner.rs` に保持。 |
...
public runner facade
  ...
  -> type-elaboration owner
     ...
     -> source extraction
        ...
        -> standalone formula-constant and shared exact numeral projections
...
| 262 | parent: type-elaboration source-extraction leaf を移動。Tasks 262A-262H0 後も open で、Task 262H が next。 |
...
| 262H | Next: builtin equality/inequality/membership config、source transport、exact extractor、dedicated allowlist だけを private source-formula leaf へ移動。 |
