...
| [module_boundary_audit.md](./module_boundary_audit.md) | `crates/mizar-test/src/runner.rs`、将来の private `src/runner/` module | Task 248 runner ownership inventory、target layout、preservation matrix、move order | Active |
