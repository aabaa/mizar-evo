...
symbol、attribute / mode argument、attributed mode head、structure、term、formula、
...
missing-evidence diagnostic または same-module local mode reserve head の missing
