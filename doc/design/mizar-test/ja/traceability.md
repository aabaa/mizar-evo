...
definition external-gap case、および task 91 の attribute definition external-gap
case を除き、task 85 の imported negative `empty`/builtin-`set` provenance slice を
...
case が task 91 の attribute definition boundary を超える未対応の
...
type-argument / term-argument provenance、term、formula、coercion、overload
payload、fact、CoreIr、ControlFlowIr、VC payload、proof payload
extraction を必要とする場合、
