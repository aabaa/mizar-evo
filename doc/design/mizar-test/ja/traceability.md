...
theorem formula external-gap case、task 98 の imported predicate/functor theorem formula external-gap case、task 100 の builtin membership theorem formula external-gap case、task 101 の builtin inequality theorem formula external-gap case、task 99 の connective/quantifier theorem formula external-gap case、task 88 の proof-block theorem external-gap case、
