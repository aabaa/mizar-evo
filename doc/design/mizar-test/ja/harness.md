...
| `src/runner/type_elaboration.rs` | 579 | 正確に11個のprivate leafを持つprivate type-elaboration facade。 |
...
11 `mod` declaration、18-path/hash pair、documented public API、exact discovered-
