...
attribute disambiguation、mode / structure argument、parameterized / contextual mode definition、
...
task-61 direct slice 外の attributed-RHS chain、
task-63 bare chain slice 外の attributed-RHS chain、
task-64 bare-builtin chain slice と task-65 structure-RHS chain slice 外の
attributed-root attributed-RHS chain、
...
structure-RHS chain diagnostic slice を含む）を
...
mode / structure argument、structure base-shape evidence、term、formula、coercion site、
