...
task-62 bare chain slice 外の structure-RHS chain、task-61 direct slice 外の attributed-RHS chain、
task-63 bare chain slice 外の attributed-RHS chain、
task 64 外の attributed-root structure / attributed-RHS chain、
...
attributed local-mode bare-builtin chain diagnostic slice を含む）を
