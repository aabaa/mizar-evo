...
まだ無いため引き続き `checker.type.external.mode_expansion_payload` を出す。runner は
fully expanded attributed mode type の evidence query を主張しない。imported attribute、
imported mode / structure、unresolved / ambiguous symbol、attribute argument、qualified
attribute disambiguation、mode / structure argument、non-reserve
