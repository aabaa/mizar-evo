...
引き続き `checker.declaration.deferred.evidence_query` を出す。imported attribute、
imported mode / structure、unresolved / ambiguous symbol、attribute argument、qualified
attribute disambiguation、attributed mode head、mode / structure argument、non-reserve
...
attributed mode head、mode / structure argument、structure payload、term、formula、coercion site、
