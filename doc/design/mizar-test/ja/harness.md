...
argument、type-argument / term-argument provenance、parameterized / contextual mode definition、
...
provenance、structure base-shape evidence、term、formula、coercion site、overload
