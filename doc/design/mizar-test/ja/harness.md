...
attributed structure RHS、task-60 direct slice 外の structure-RHS chain、attributed-RHS chain、
...
slice、task-60 attributed local-mode structure-RHS diagnostic slice を含む）を
