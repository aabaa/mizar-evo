...
recovery/diagnostic site を持たないことを確認する。これは summary-readiness の確認だけであり、
`CoreContext`、`CoreIr`、`ControlFlowIr`、obligation seed、VC、proof row は構築しない。
...
assembly、`ResolvedTypedAst` assembly、summary-readiness の実行を確認する場合だけ、
