...
- [ ] test layout 安定後、production helper を監査済み phase/ownership boundary
  ...
  Tasks 258-259 で private shared frontend と parse-only owner は完了し、Task
  260A で shared resolver leaf を caller より先に移動した。次は Task 260B であり、
  Tasks 260B-263 が残るため、この parent item は open のまま。
