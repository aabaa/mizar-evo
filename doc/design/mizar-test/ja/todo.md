...
18. **Source-derived reserve declaration semantic bridge。** [x]
    ...
    - 未対応の non-builtin declaration、task-84 `TypeCaseAttr` bridge と task-80
      boundary を超える imported attribute provenance、task-83 `R` bridge と task-78 boundary を超える
