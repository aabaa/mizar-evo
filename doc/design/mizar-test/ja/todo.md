...
- [ ] test layout 安定後、production helper を監査済み phase/ownership boundary
  ...
  identical body/byte-stabilityを維持して完了した。fresh inventoryはradix、multi-hop、
  local-object-mode long-chain asserted-head routeへ戻るため、Task 263 parent itemはopenのまま。
