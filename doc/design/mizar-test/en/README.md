...
| [module_boundary_audit.md](./module_boundary_audit.md) | `crates/mizar-test/src/runner.rs`, future private `src/runner/` modules | Task 248 runner ownership inventory, target layout, preservation matrix, and move order | Active |
| [bilingual_sync_audit.md](./bilingual_sync_audit.md) | `doc/design/mizar-test/en`, `doc/design/mizar-test/ja` | Task 13 EN/JA synchronization baseline and task 15 architecture-22 follow-up audit | Draft |
