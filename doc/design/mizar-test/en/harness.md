...
RHSs, structure-RHS chains outside the task-60 direct slice, attributed-RHS
chains outside the task-61 direct slice, forward-reference or cyclic
local-mode chains, and non-reserve declarations remain outside this source
bridge.
...
slice, to `mizar-checker`'s source
