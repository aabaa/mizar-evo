...
instead of `checker.type.external.mode_expansion_payload`. Imported
...
chains, forward-reference or cyclic local-mode chains, and non-reserve
...
diagnostic slice, to `mizar-checker`'s source
