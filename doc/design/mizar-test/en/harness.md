...
`TypeCaseMode`, task-83 `R`, task-84 `TypeCaseAttr`, and task-85 negative
...
task-80 boundary, imported structures beyond the task-83 `R` bridge and task-78
