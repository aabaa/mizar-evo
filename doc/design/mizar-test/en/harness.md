...
inserting a partial `B -> A` payload. Imported
...
forward-reference or cyclic local-mode chains, and non-reserve declarations
remain outside this source bridge.
...
supported same-module local-mode expansion payloads to `mizar-checker`'s source
