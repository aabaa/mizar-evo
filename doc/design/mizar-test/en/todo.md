...
- [~] [Step 5C.14: algorithms](../../task_contracts/en/STEP5C14-ALGORITHM-SEMANTICS.md); static diagnostics and bounded flat-state return/assertion VCs; bounded void-claim VCs active; contradictory-assertion failure and bounded computation requests active, other control-flow/VC slices remain deferred.
