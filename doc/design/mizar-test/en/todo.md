...
18. **Source-derived reserve declaration semantic bridge.** [x]
    ...
    - Unsupported non-builtin declarations beyond task 91's attribute definition
      boundary, imported attribute provenance beyond
      ...
      mode/structure heads, structure base-shape payloads, definition payloads beyond the task-91 extraction-gap boundary, terms and
