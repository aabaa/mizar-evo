...
18. **Source-derived reserve declaration semantic bridge.** [x]
    ...
    - Unsupported non-builtin declarations beyond task 92's mode/structure
      ...
      mode/structure heads, structure base-shape payloads, definition payloads beyond the task-92 extraction-gap boundary, terms and
