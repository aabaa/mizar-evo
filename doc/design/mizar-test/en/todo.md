...
- [ ] After the test layout is stable, split production helpers along the
  ...
  Task 262C moved the reserve type-expression/symbol-projection leaf, and Task
  262D moved the shared exact fixture-import AST projection. The remaining Task
  262 declaration/mode and formula extraction families and Task 263 keep this
  parent item open.
