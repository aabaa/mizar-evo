...
- [ ] After the test layout is stable, split production helpers along the
  ...
  shared symbol projection moved in Task 262J1. The remaining Task 262 formula
  extraction work continues with the imported predicate/functor family move in
  J2. Remaining formula families and Task 263 keep this parent item open.
