...
grown through parser task 38, including module/import/export,
...
expansion, and parse-only `SurfaceAst` snapshot baselines. Hardening/audit tasks
39-45 remain planned.
