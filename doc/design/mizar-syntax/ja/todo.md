...
| モジュール | 仕様 | ソース | 状態 |
|---|---|---|---|
| ast | [ast.md](./ast.md) | `src/ast.rs` | [x] rowan storage 境界と task-35 vocabulary は完了済み。S-019 source/spec audit で欠落実装は見つからなかった。task 24 で挙動維持の source split を追跡 |
