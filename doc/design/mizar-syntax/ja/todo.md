...
| モジュール | 仕様 | ソース | 状態 |
|---|---|---|---|
| ast | [ast.md](./ast.md) | `src/ast.rs` | [x] rowan storage 境界、task-35 vocabulary、task 22 の predicate-label follow-through は完了済み。S-023 audit で残る predicate-label gap は見つからなかった。task 24 で挙動維持の source split を追跡 |
