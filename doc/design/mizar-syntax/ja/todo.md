...
| モジュール | 仕様 | ソース | 状態 |
|---|---|---|---|
| ast | [ast.md](./ast.md) | `src/ast.rs`, `src/ast/{green,snapshot,tests}.rs` | [x] rowan storage 境界、task-35 vocabulary、task 22 の predicate-label follow-through、task 24 の挙動維持 source split は完了済み。S-023 audit で残る predicate-label gap は見つからなかった |
