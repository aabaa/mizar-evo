...
formula operand、proof step、statement、skipped token、unmatched delimiter、および
task 33 algorithm-control recovery の明示的な recovered node を生成する。下の表が現在の
