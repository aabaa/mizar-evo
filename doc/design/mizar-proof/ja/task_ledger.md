...
Rationale: task 5 は code の前に deterministic winner-selection contract を定義する。
...
selection に新しい external dependency gap が必要な場合だけ上げる。
