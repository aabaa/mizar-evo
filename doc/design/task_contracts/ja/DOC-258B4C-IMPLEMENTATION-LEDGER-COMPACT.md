...
EN/JA、本batch EN/JA pair、`legacy_compactions.tsv`を変更する。49-line sections 2件は
`258B4C.md#completion-evidence`へのlanguage-local redirects 2件となり、exact source
diffは`+2/-47`。neighboring H2 anchors 4件はbyte-identical。
