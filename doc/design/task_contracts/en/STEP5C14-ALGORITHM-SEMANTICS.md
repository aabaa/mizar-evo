...
Status: partial; static/state and bounded void-claim VCs active; contradictory-assertion failure active; computation request active; flat snapshot capture active; bounded while generation active; bounded return-Pick failure active; tier: full. Primary owner: mizar-core; consumers: mizar-vc, mizar-test;
...
Authority: [2](../../../spec/en/02.lexical_structure.md) §2.7, [3](../../../spec/en/03.type_system.md) §3.4, [16](../../../spec/en/16.theorems_and_proofs.md) §§16.1–2; [13](../../../spec/en/13.term_expression.md) §§13.4.1,13.5,13.8.6 and [17](../../../spec/en/17.clusters_and_registrations.md) §17.3.4; [14](../../../spec/en/14.formulas.md) §§14.3.5,14.5.2; spec [20](../../../spec/en/20.algorithm_and_verification.md)
§§20.1.1–4, 20.2.2/6, 20.3, 20.4.1–3, 20.6.1–2, 20.9.2 and 20.13.1/3/5; tests/miz/{pass,fail}/algorithms/
...
For the negative assertion, preserve the real Not(Eq) graph and complete open VC; only whole-result replay with the same immutable object parameter and its consistent guard may yield failure. No pending assertion, unknown goal or terminating annotation is failure evidence. The bounded [return-Pick observer](../../mizar-vc/en/discharge.md#bounded-pick-postcondition-failure) targets unchanged `fail_proof_verification_algorithm_ensures_unprovable_001.miz`; complete replay and the foundational counterexample own its failure observation.
...
Core; no parallel AST, accepted algorithm fact or fabricated type evidence. The bounded return choice uses existing Pick and a genuine Open existential inhabitation obligation; broader Pick remains deferred.
...
Exit with authentic static observations and open return/assertion/claim/computation VCs plus bounded assertion and approved Pick-postcondition failure observations, preserved boundaries,
