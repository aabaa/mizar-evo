...
Status: partial; static/state and bounded void-claim VCs active; tier: full. Primary owner: mizar-core; consumers: mizar-vc, mizar-test;
...
activate only these sidecars without changing semantic expectations; return/state cases retain generated/zero-VC baselines; the void claim adds its full generated VcSet baseline and narrow snapshot trace.
...
static-source coverage. Preserve the repaired claim fixture and all other source/semantic expectations; no execution, theorem acceptance or Task274 credit follows.
...
Exit with authentic static observations and open return/assertion/claim VCs, preserved boundaries,
