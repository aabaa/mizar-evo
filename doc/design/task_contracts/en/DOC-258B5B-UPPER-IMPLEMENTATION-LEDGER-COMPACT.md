...
| Status | Prerequisite reviews, verification, and independent final quality complete; exact staging and the dedicated prerequisite commit remain. Selected sources and schema-2 ledger are unchanged. |
