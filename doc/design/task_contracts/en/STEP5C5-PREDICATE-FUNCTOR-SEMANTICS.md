...
| Field | Value |
|---|---|
| Status | Partial: sixteen outcomes complete; means/equals correctness remains pending; narrower-loci registration deferred |
...
| Dependencies | Prior fifteen C5 outcomes and approved fresh-equals coherence authority; existing source theorem seal, term/application typing, Core definition/proof and VC intake |
| Audit impact | Update Chapters 10/16 for pending equals-functor coherence/theorem Core/VC ownership; preserve other coverage and the approved specification |
