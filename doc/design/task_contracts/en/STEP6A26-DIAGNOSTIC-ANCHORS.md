...
Status: implemented. Tier: full. Owner: [diagnostics plan](../../mizar-diagnostics/en/00.crate_plan.md), failure records; dependency: existing mizar-session SourceAnchor. Consumer: future frontend diagnostic bridge.
