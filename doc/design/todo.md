...
5. [~] **[5C.5 — Predicates and functors](./task_contracts/en/STEP5C5-PREDICATE-FUNCTOR-SEMANTICS.md)** (`mizar-checker`; spec ch. 9
   ...
   `spec.en.10.functors.*` (8 ids). Targets: 17 pairs; nine complete,
   plus commutativity typing complete; negated-predicate checking complete; six other G1/G2/G6/G9 gaps deferred. Covers
