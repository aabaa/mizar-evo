...
| mizar-checker | Type checking, cluster/registration resolution, overload resolution | [x] explicit-payload milestone complete; spec wave in progress through task 40 | steps 2, 4, 5 (tasks 41-48) | [todo](./mizar-checker/en/todo.md) |
