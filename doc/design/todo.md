...
| mizar-test | Corpus discovery, expectations, staged model, traceability, harness | [~] foundation complete through task 22; Tasks 265-268, Core-31, and Checker consumers through committed Task 269B are implemented | Complete Checker Task 269CP's frozen docs prerequisite and runner-private lower implementation | [todo](./mizar-test/en/todo.md) |
| mizar-checker | Type checking, cluster/registration resolution, overload resolution | [~] explicit-payload milestone and source producers/consumers through committed Task 269B are implemented | Complete Checker Task 269CP's frozen docs prerequisite, then its no-checker-source runner lower implementation | [todo](./mizar-checker/en/todo.md) |
...
- [ ] Fresh-preflight and implement/verify/commit only Task 269CP, then
  continue automatically to binding-only Task 269C with a missing type site;
  source-type admission remains a separately selected prerequisite.
