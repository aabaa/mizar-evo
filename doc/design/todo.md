...
1. [~] Real phase services and producer publication among `mizar-ir`,
   ...
   [lexical contribution storage](./task_contracts/en/STEP6A8-LEXICAL-SYMBOL-CODEC.md), then [unique lexical key binding](./task_contracts/en/STEP6A9-LEXICAL-KEY-BINDING.md).
