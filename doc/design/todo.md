...
| mizar-test | Corpus discovery, expectations, staged model, traceability, harness | [~] foundation complete through task 22; Tasks 265-268 and Core-31 consumer increment complete; Checker Task-249 consumer and Task-250 consumer contract complete | step 5 task 10, beginning with Checker Task-250 implementation, then dependency-paced Task-251+ consumers, future `MT10-FS`/`MT10-AS`, and five Core-32 consumer increments | [todo](./mizar-test/en/todo.md) |
| mizar-checker | Type checking, cluster/registration resolution, overload resolution | [x] explicit-payload milestone, bridges through Task 246, Tasks 266-268 final handoff, Task 247 decomposition, Tasks 248-249 producers, and the independent Task-250 frozen-contract prerequisite complete | Task 250 implementation, then Tasks 251-264/269-279; task 49 dependency-gated on blocked external slices | [todo](./mizar-checker/en/todo.md) |
