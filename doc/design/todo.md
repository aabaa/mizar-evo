...
| mizar-checker | Type checking, cluster/registration resolution, overload resolution | [x] explicit-payload milestone complete; spec-decision wave complete; step 4 tasks 45-47 complete; step 5 tasks 48 and 50-77 complete | step 5 source-derived bridge slices; task 49 remains dependency-gated | [todo](./mizar-checker/en/todo.md) |
...
local structure reserve extraction-gap boundary slice, and task 70 added the
   ...
   later local structure declaration, and task 77 added the corresponding
   lower-stage boundary for a later local attribute declaration).
