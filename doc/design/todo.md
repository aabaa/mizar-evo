...
| mizar-resolve | yes | Module graph, namespaces, symbols, labels, signature collection | [~] tasks 1-20 complete; per-kind signature extraction is next | [todo](./mizar-resolve/en/todo.md) |
...
1. **mizar-resolve symbols wave** - resolver tasks 1-20 have landed, including
   ...
   skeleton. Continue with per-kind signature extraction task 21.
