...
| mizar-resolve | yes | Module graph, namespaces, symbols, labels, signature collection | [~] tasks 1-23 and 25-26 complete; task 24 is deferred on `mizar-artifact` task 5; hardening tasks 27-29 are next | [todo](./mizar-resolve/en/todo.md) |
...
1. **mizar-resolve hardening wave** - resolver tasks 1-23 have landed, including
   ...
   forward-compatibility policy; continue with resolver hardening tasks 27-29.
