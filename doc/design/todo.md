...
- **Frontend crate boundary.** Decide whether source loading lives in a dedicated
  `mizar-frontend` crate or is folded into an existing crate; the architecture docs
  list `mizar-frontend/source.md` as a not-yet-created module spec root.
