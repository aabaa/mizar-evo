...
| mizar-resolve | yes | Module graph, namespaces, symbols, labels, signature collection | [~] tasks 1-21 complete; recovered-syntax policy is next | [todo](./mizar-resolve/en/todo.md) |
...
1. **mizar-resolve symbols wave** - resolver tasks 1-21 have landed, including
   ...
   skeleton plus parser-backed per-kind signature extraction. Continue with
   recovered-syntax policy task 22.
