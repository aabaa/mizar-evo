...
| mizar-resolve | yes | Module graph, namespaces, symbols, labels, signature collection | [~] tasks 1-23 and 25 complete; task 24 is deferred on `mizar-artifact` task 5; hardening tasks 26-29 are next | [todo](./mizar-resolve/en/todo.md) |
...
1. **mizar-resolve hardening wave** - resolver tasks 1-23 have landed, including
   ...
   explicitly deferred on `mizar-artifact` task 5, and task 25 adds the
   crate-root determinism suite; continue with resolver hardening tasks 26-29.
