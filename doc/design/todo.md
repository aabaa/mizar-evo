...
| mizar-vc | VC IR, VC generation, deterministic pre-ATP discharge | [x] kernel-evidence handoff milestone complete | steps 1, 3 (tasks 28-29), 5; task 27 resolved | [todo](./mizar-vc/en/todo.md) |
