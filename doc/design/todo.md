...
| mizar-test | Corpus discovery, expectations, staged model, traceability, harness | [~] foundation complete through task 22; Tasks 265-268, Core-31, and Checker Tasks 248-250 consumer increments complete; Checker Task-251 consumer contract frozen | step 5 task 10, implementing the exact Task-251 consumer, then dependency-paced later consumers, future `MT10-FS`/`MT10-AS`, and five Core-32 consumer increments | [todo](./mizar-test/en/todo.md) |
| mizar-checker | Type checking, cluster/registration resolution, overload resolution | [x] explicit-payload milestone, bridges through Task 246, Tasks 266-268 final handoff, Task 247 decomposition, Tasks 248-250 source-payload producers complete, and Task-251 producer contract frozen | implement Task 251, then Tasks 252-264/269-279; task 49 dependency-gated on blocked external slices | [todo](./mizar-checker/en/todo.md) |
