...
5. [~] **[5C.5 — Predicates and functors](./task_contracts/en/STEP5C5-PREDICATE-FUNCTOR-SEMANTICS.md)** (`mizar-checker`; spec ch. 9
   ...
   `spec.en.10.functors.*` (8 ids). Targets: 17 pairs; fourteen outcomes complete; phrase-predicate VC generation complete;
   symbolic predicate generation complete; three other G1/G2/G9 gaps deferred. Covers
...
14. [~] **[5C.14 — Algorithm verification](./task_contracts/en/STEP5C14-ALGORITHM-SEMANTICS.md)** (`mizar-checker`,
    ...
    pairs (eight active; false ensures and while remain deferred). Covers `var`/`const`/`assert`, contracts
