...
The import pre-scan consumes raw lexer output. Raw scanning itself does not interpret imports or construct the active lexicon.
...
| user-defined symbols containing `.` | disambiguator | recognized by active lexicon, parser context, scope override rules, and longest-match |
...
- `doc/design/mizar-frontend/lexicon.md` — active lexicon seed assembly from imports and dependency summaries
