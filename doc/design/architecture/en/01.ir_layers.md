...
The task-11 syntax boundary is minimal. It owns:

- token nodes in source order
- source ranges for token and infix nodes
- optional root and expression-root node ids
- recovered flags for recovered token nodes

Full module structure, trivia maps, and the broader recovered syntax tree are
