...
| `02.artifact_store_cache_key_and_manifest.md` | 15 | artifact store、cache key construction、manifest transactions、reproducible write protocol | Planned |
| `03.diagnostics_model_and_lsp_bridge.md` | All, 15 | diagnostic registry、aggregation、explanation handles、LSP snapshot bridge、editor freshness model | Planned |
| `04.atp_portfolio_and_kernel_check_integration.md` | 13-14 | ATP portfolio execution、backend evidence selection、proof witness storage、kernel check scheduling | Planned |
