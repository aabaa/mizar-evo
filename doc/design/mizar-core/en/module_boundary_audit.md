...
| `src/elaborator.rs` | 12310 | `elaborator.md` | Largest review-risk file, but its sections map to the six elaboration steps in the owning spec. The audit does not classify it as a current review-bottleneck requiring a split. |
