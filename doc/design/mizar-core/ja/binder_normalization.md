...
task 21 は `binder_normalization` の public enum をすべて downstream
forward-compatible API surface として分類する。将来の binder、substitution、
canonicalization、diagnostic category を下流 crate の exhaustive match を壊さずに
