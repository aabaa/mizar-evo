...
| `src/elaborator.rs` | 14914 | `elaborator.md` | 最大の review-risk file だが、section は owning spec の six elaboration step に対応する。Task 29 の scheme-actual validation fixture は Step 2 type/fact elaboration boundary 内に残る。この audit は split を要求する current review-bottleneck とは分類しない。 |
...
Task 29 では explicit scheme-actual validation payload と Rust fixture を
