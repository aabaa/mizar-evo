...
| `src/elaborator.rs` | 12310 | `elaborator.md` | 最大の review-risk file だが、section は owning spec の six elaboration step に対応する。この audit は split を要求する current review-bottleneck とは分類しない。 |
