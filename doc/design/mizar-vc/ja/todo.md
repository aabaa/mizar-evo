...
- Kernel evidence handoff record は checking 用の formula/substitution evidence を
  package してよいが、`mizar-vc` は SAT solving を実行したり backend-specific
  proof method を encode したりしてはならない。
