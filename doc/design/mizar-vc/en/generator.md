...
Preserve every handoff row: ghost initialization retains its existing GhostErasure/NoConcreteVc accounting and termination its original unresolved status. A capture is neither a proof nor a ghost-erasure certificate; snapshot claim substitution, loops beyond the bounded while and false-ensures verification remain unsupported.
