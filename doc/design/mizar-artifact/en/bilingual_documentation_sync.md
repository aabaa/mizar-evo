...
| [proof_witness.md](./proof_witness.md) | [../ja/proof_witness.md](../ja/proof_witness.md) | Ownership, witness reference shape, hash domains, witness paths, resident-set discipline, ordering, reader/writer rules, public-enum policy, and implementation boundary are synchronized. |
