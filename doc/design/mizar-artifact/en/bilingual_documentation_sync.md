...
Task 21 audits the bilingual documentation set after task 20. Task 24 keeps this
audit current after the proof-witness schema re-check. English documents under
`doc/design/mizar-artifact/en/` are canonical; Japanese documents under
...
|---|---|---|
| [00.crate_plan.md](./00.crate_plan.md) | [../ja/00.crate_plan.md](../ja/00.crate_plan.md) | Task results through task 24, active gaps, verification expectations, and exit criteria are synchronized. |
| [todo.md](./todo.md) | [../ja/todo.md](../ja/todo.md) | Task statuses through task 24, task 17 deferral, and task 18-24 status notes are synchronized. |
...
| [proof_witness.md](./proof_witness.md) | [../ja/proof_witness.md](../ja/proof_witness.md) | Ownership, schema version `2.0`, formula/substitution evidence reference shape, task-24 no-change schema decision, hash domains, legacy certificate rejection, witness paths, resident-set discipline, ordering, reader/writer rules, public-enum policy, and implementation boundary are synchronized. |
| [verified_artifact.md](./verified_artifact.md) | [../ja/verified_artifact.md](../ja/verified_artifact.md) | Ownership, top-level shape, exports, expression metadata, obligations/formula-evidence witnesses, task-24 indirect goal-polarity/context-identity coverage, diagnostics, provenance, hash domains/participation, ordering, reader/writer rules, public-enum policy, and implementation status are synchronized. |
...
| [source_spec_correspondence.md](./source_spec_correspondence.md) | [../ja/source_spec_correspondence.md](../ja/source_spec_correspondence.md) | Task 20 scope plus task 23 and task 24 rerun scopes, classification result, public API trace, promised behavior trace, remaining gaps, and verification note are synchronized. |
| [bilingual_documentation_sync.md](./bilingual_documentation_sync.md) | [../ja/bilingual_documentation_sync.md](../ja/bilingual_documentation_sync.md) | Task 21 audit scope, pair inventory through task 24, audit notes, and verification note are synchronized. |
...
Task 24 is documentation-only. Required verification includes `git diff --check`
after the audit files and status updates are staged; artifact schema tests may be
run as a regression check for the unchanged wire shape.
