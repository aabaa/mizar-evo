...
\begin{tikzpicture}[
  ...
  \node[plabel, above=3mm of b1]
    {theorem proof edit:\\ public statement + accepted status unchanged --- importers reuse};
  ...
  \node[note, below=3.5mm of b2]
    {reuse requires all relevant keys: source/dependency slices, package/lockfile,\\
     toolchain/schema, registration/cluster, verifier policy, evidence/witnesses;\\
     missing data is a cache miss --- a clean build must reproduce every acceptance};
\end{tikzpicture}
\end{document}
