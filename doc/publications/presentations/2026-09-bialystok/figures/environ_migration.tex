...
\begin{tikzpicture}[
  ...
  \node[target, right=22mm of reg] (treg) {import-scoped view of\\ the registration index};
  ...
  \node[font=\sffamily\small\itshape, text=black!70, below=2mm of thm,
        align=center, text width=36mm]
    {implicit, article-scoped, resolved by the Accommodator};
  \node[font=\sffamily\small\itshape, text=black!70, below=2mm of tthm,
