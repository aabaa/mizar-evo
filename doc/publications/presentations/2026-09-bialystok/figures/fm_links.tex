...
\begin{tikzpicture}[
  ...
  layer/.style={draw, rounded corners=2pt, align=left, minimum width=62mm,
                minimum height=7mm, line width=0.6pt, inner sep=1.5mm,
                font=\sffamily\small},
  role/.style={font=\sffamily\small\itshape, text=black!70, align=left,
               anchor=west},
  ...
  \node[layer, below=of hash, fill=gray!14, draw=black!55] (origin)
    {origin id \texttt{(mizar:GROUP\_1:\dots)}\\[-1pt]
     format sketch};
  ...
  \node[role] at ([xshift=4mm]fm.east)     {research citation};
  ...
  \node[role] at ([xshift=4mm]origin.east) {links to MML citations};

  \node[font=\sffamily\small\itshape, text=black!70, align=center,
        below=2mm of origin]
    {linked records/references, not a derivation};
\end{tikzpicture}
\end{document}
