% Figure: the core ATP path with responsibility groups (part 10).
...
\begin{tikzpicture}[
  ...
  \node[art, left=of prob, fill=green!12, draw=green!45!black] (cert) {KernelEvidence\\ \scriptsize candidate};
  ...
  \draw[flow] (vc) -- (prob);
  \draw[flow] (prob) -- (cert);
  \draw[flow] (cert) -- node[font=\sffamily\scriptsize, above] {check} (ver);
