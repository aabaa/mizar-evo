...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item None of the three pressures argues that Mizar's design was wrong. Together they argue for evolving its boundaries.
\end{itemize}
\note{
\smallskip
\textbf{Presenter script:}
...
Use this as the transition: The Evo Answer: Diamonds Become Checkable (1/2). Point to the visible example, question, or diagram before moving on.
...
\smallskip
\textbf{Presenter script:}
Use this as the transition: Certificates, Not Success Bits (1/2). Point to the visible example, question, or diagram before moving on.
...
Use this as the transition: The Evo Answer: Fingerprints And Incrementality (2/2). Point to the visible example, question, or diagram before moving on.
