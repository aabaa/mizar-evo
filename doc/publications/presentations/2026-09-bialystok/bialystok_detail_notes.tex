...
\item \textcolor{blue!55!black}{\textbf{Thank you for inviting me to Bialystok. Today I will introduce Mizar Evo.}}
\item \textcolor{blue!55!black}{\textbf{Mizar is a system for writing mathematical proofs and checking them by computer. Evo is a project to update its language and tools while keeping proofs readable.}}
\item \textcolor{blue!55!black}{\textbf{I will give an overview. The handout keeps the details for later review.}}
...
\centering\itshape \textcolor{blue!55!black}{\textbf{Preserve Mizar's mathematical vernacular.}}\\ \textcolor{blue!55!black}{\textbf{Update the compiler, verifier, artifact, and publication layers.}}
\end{beamercolorbox}
\end{center}
\begin{itemize}
\setlength{\itemsep}{1pt}
...
\item \textcolor{blue!55!black}{\textbf{The language standard is still a draft. Full MML migration is not complete.}}
\item AI assistance must never replace proof checking.
\item \textcolor{blue!55!black}{\textbf{The Evo examples follow the specification. Some are not yet implemented. I will explain the current implementation scope near the end.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Preserve Mizar's mathematical vernacular.}} \textcolor{blue!55!black}{\textbf{Update the compiler, verifier, artifact, and publication layers.}}
\item This is the main proposal. We build on what current Mizar has achieved.
\item \textcolor{blue!55!black}{\textbf{The language standard is still a draft. Full MML migration is not complete.}}
\item AI assistance must never replace proof checking.
\item \textcolor{blue!55!black}{\textbf{The Evo examples follow the specification. Some are not yet implemented. I will explain the current implementation scope near the end.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The purpose of this visit is to learn from your experience with Mizar.}}
\item I would like to identify compatibility needs and choose small MML articles for migration experiments.
\item \textcolor{blue!55!black}{\textbf{I also hope to discuss how we check results from automated theorem provers, or ATPs. Another topic is how we link our work to Formalized Mathematics.}}
...
\begin{center}
\begin{beamercolorbox}[rounded=true,sep=2.5mm,wd=0.9\textwidth]{keyphrase}
\centering\itshape \textcolor{blue!55!black}{\textbf{What must Mizar Evo preserve so that the Mizar community}}\\ \textcolor{blue!55!black}{\textbf{still recognizes it as Mizar?}}
\end{beamercolorbox}
\end{center}
\note{
\smallskip
...
\item \textcolor{blue!55!black}{\textbf{I also hope to discuss how we check results from automated theorem provers, or ATPs. Another topic is how we link our work to Formalized Mathematics.}}
\item My main question is this.
\item \textcolor{blue!55!black}{\textbf{What must Mizar Evo preserve so that the Mizar community}} \textcolor{blue!55!black}{\textbf{still recognizes it as Mizar?}}
\end{itemize}
\smallskip
\textbf{Optional notes and sources:}
\begin{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{First, let me explain what I want to keep.}}
\item \textcolor{blue!55!black}{\textbf{Mizar proofs are declarative and read as mathematics.}}
\item Soft types, modes, and attributes give us a rich mathematical vocabulary.
\item \textcolor{blue!55!black}{\textbf{Registrations and clusters provide automation that other proofs can reuse.}}
\item \textcolor{blue!55!black}{\textbf{The Mizar Mathematical Library, or MML, is large and carefully maintained. Formalized Mathematics provides a way to publish this work.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The first reason for this work is library size.}}
\item MML has roughly 1500 articles that depend on each other.
\item \textcolor{blue!55!black}{\textbf{An article is the unit of dependency, review, and reuse.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The second reason is the way people now expect tools to work.}}
\item \textcolor{blue!55!black}{\textbf{We expect editors to give quick feedback, even while the source is incomplete.}}
\item \textcolor{blue!55!black}{\textbf{We expect a manifest and lockfile to make builds reproducible.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The third reason is AI assistance.}}
\item \textcolor{blue!55!black}{\textbf{AI tools can help us search, explain, and edit proofs.}}
...
\item \textcolor{blue!55!black}{\textbf{Their output must still be checked. Proof validity must not depend on how capable the AI tool is.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Our first story is about dependencies. These lists tell Mizar which library material an article needs.}}
\item \textcolor{blue!55!black}{\textbf{This form has supported library growth for decades. The question is how to make dependencies easier to review in a larger library.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item Article order matters in environment lists such as \texttt{notations} and \texttt{definitions}. Authors must understand not only which articles to include, but also how to order them.
...
\item Users must list individual articles even when they want a whole topic, such as elementary group theory.
...
\smallskip
\textbf{\textcolor{blue!55!black}{\textbf{Evo puts imports before definitions}}}~\badgeSpec
\begin{lstlisting}[language={mizar},basicstyle=\ttfamily\footnotesize]
import .function;
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Here, the imports come before the first non-import item.}}
\item \textcolor{blue!55!black}{\textbf{They provide the initial active lexicon. Local declarations extend it after their declaration points.}}
\item \textcolor{blue!55!black}{\textbf{Imported items keep their source FQNs. Package and module paths give each item a stable fully-qualified name.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Evo puts imports before definitions}}.
\item \textcolor{blue!55!black}{\textbf{Here, the imports come before the first non-import item.}}
\item \textcolor{blue!55!black}{\textbf{They provide the initial active lexicon. Local declarations extend it after their declaration points.}}
\item \textcolor{blue!55!black}{\textbf{Imported items keep their source FQNs. Package and module paths give each item a stable fully-qualified name.}}
\end{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item With \texttt{export}, a library can offer a topic such as elementary group theory through one aggregate module and a single import.
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The aim is to preserve the mathematics and theorem identities during migration.}}
...
\item \textcolor{blue!55!black}{\textbf{The questions below are for later review. I will now turn to structures.}}
\end{itemize}
\smallskip
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{One declaration contains the parent link, fields, and selectors.}}
...
\item \textcolor{blue!55!black}{\textbf{The syntax does not separate stored data from canonical values such as zero.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item Current Mizar defines \texttt{addMagma} and \texttt{multMagma} separately, although both describe a carrier with one binary operation.
\item Common definitions and proofs are repeated in additive and multiplicative forms.
\item Evo's member renaming lets both structures use a common \texttt{Magma} theory, while keeping their familiar operation names.
\end{itemize}
\smallskip
\textbf{Message:}
\begin{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Define and prove the common theory once, then reuse it through renamed views.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\smallskip
\textbf{\textcolor{blue!55!black}{\textbf{Evo separates fields, properties, and attributes}}}~\badgeSpec
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{A field stores data, like \texttt{carrier} and \texttt{add} here. Fields are constructor arguments and determine equality of exact instances.}}
\item \textcolor{blue!55!black}{\textbf{A property, like \texttt{zero} here, gets its value from an implementation. The declaration alone supplies no value. \texttt{means} requires existence and uniqueness; \texttt{equals} gives a term.}}
\item \textcolor{blue!55!black}{\textbf{An attribute is a predicate-style refinement. It supports cluster propagation and does not change the layout.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Evo separates fields, properties, and attributes}}.
\item \textcolor{blue!55!black}{\textbf{A field stores data, like \texttt{carrier} and \texttt{add} here. Fields are constructor arguments and determine equality of exact instances.}}
\item \textcolor{blue!55!black}{\textbf{A property, like \texttt{zero} here, gets its value from an implementation. The declaration alone supplies no value. \texttt{means} requires existence and uniqueness; \texttt{equals} gives a term.}}
\item \textcolor{blue!55!black}{\textbf{An attribute is a predicate-style refinement. It supports cluster propagation and does not change the layout.}}
\end{itemize}
...
\smallskip
\textbf{\textcolor{blue!55!black}{\textbf{Evo writes each parent mapping explicitly}}}~\badgeSpec
\begin{lstlisting}[language={mizar},basicstyle=\ttfamily\footnotesize]
definition
  struct AddMagma where
    field carrier -> set;
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{There is one \texttt{inherit} statement for each parent.}}
\item \textcolor{blue!55!black}{\textbf{Here, \texttt{from} maps the child's \texttt{add} field to the parent's \texttt{binop} field.}}
\item \textcolor{blue!55!black}{\textbf{Syntactically identical member types need no proof, even if a name changes. Other types need \texttt{coherence} proofs of subtype inclusion.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Evo writes each parent mapping explicitly}}.
\item \textcolor{blue!55!black}{\textbf{There is one \texttt{inherit} statement for each parent.}}
\item \textcolor{blue!55!black}{\textbf{Here, \texttt{from} maps the child's \texttt{add} field to the parent's \texttt{binop} field.}}
\item \textcolor{blue!55!black}{\textbf{Syntactically identical member types need no proof, even if a name changes. Other types need \texttt{coherence} proofs of subtype inclusion.}}
\end{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Define and prove once for \texttt{Magma}; reuse through the additive and multiplicative views.}}
\item The views stay distinct; theorem assumptions must hold for each view.
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\item \textcolor{blue!55!black}{\textbf{The main question is whether this form is readable in real algebraic articles.}}
\item \textcolor{blue!55!black}{\textbf{I would like to test it on structures with several inheritance paths. Next, I will discuss registrations and clusters.}}
\end{itemize}
\smallskip
\textbf{Questions for later review:}
\begin{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Registrations let attributes propagate automatically, so proofs stay short.}}
\item \textcolor{blue!55!black}{\textbf{I want to keep this idea and make the steps of the automation easier to see.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\smallskip
\textbf{\textcolor{blue!55!black}{\textbf{Evo gives every registration item a label}}}~\badgeSpec
\begin{lstlisting}[language={mizar},basicstyle=\ttfamily\small]
registration
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Labels make cluster use traceable. Explicit citation in \texttt{by} is optional.}}
\item \textcolor{blue!55!black}{\textbf{The verifier applies applicable clusters automatically within the active environment.}}
\item \textcolor{blue!55!black}{\textbf{\texttt{explain-attribute} and resolution traces explain success or failure. For example, they can show the steps from empty to finite to countable.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Evo gives every registration item a label}}.
\item \textcolor{blue!55!black}{\textbf{Labels make cluster use traceable. Explicit citation in \texttt{by} is optional.}}
\item \textcolor{blue!55!black}{\textbf{The verifier applies applicable clusters automatically within the active environment.}}
\item \textcolor{blue!55!black}{\textbf{\texttt{explain-attribute} and resolution traces explain success or failure. For example, they can show the steps from empty to finite to countable.}}
\end{itemize}
...
\begin{frame}[fragile,t]{4.5 - Overloading: Which Definition Does This Mean?}
\begin{itemize}
\setlength{\itemsep}{1pt}
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The same symbol can have several definitions. Its spelling alone does not tell us which one applies.}}
\item Cluster inference can make an argument fit several parameter types.
\item \textcolor{blue!55!black}{\textbf{For example, a finite topological space is both countable and compact. If \texttt{f} has an overload for each, both may apply.}}
\item We need a clear selection rule and a way to state our intent when it cannot choose.
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item Specification sections 19.2.1 and 19.4.4 supply the example with the required registrations. The two overloads are independent definitions; neither parameter type is more specific than the other.
\end{itemize}
}
\end{frame}

\begin{frame}[fragile,t]{4.6 - The Evo Answer: Resolve Or Explain Ambiguity}
\smallskip
\textbf{Two independent overloads, with the required registrations}~\badgeSketch
\begin{lstlisting}[language={mizar},basicstyle=\ttfamily\small]
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Evo prefers more specific parameter types after cluster inference. Return types do not choose the overload.}}
\item \textcolor{blue!55!black}{\textbf{If several best definitions remain, Evo reports ambiguity. Here, \texttt{qua} makes the intended type explicit.}}
\item \textcolor{blue!55!black}{\textbf{This selects the meaning before proof search begins.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item Two independent overloads, with the required registrations.
\item \textcolor{blue!55!black}{\textbf{Evo prefers more specific parameter types after cluster inference. Return types do not choose the overload.}}
\item \textcolor{blue!55!black}{\textbf{If several best definitions remain, Evo reports ambiguity. Here, \texttt{qua} makes the intended type explicit.}}
\item \textcolor{blue!55!black}{\textbf{This selects the meaning before proof search begins.}}
\end{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item Source: specification sections 19.3.1 and 19.4. These are illustrative calls.
\item Scope and tie-breakers also apply; coherent \texttt{redefine} items of one root combine (section 19.5).
\item Qualify ambiguous imports with \texttt{module\_path.symbol\_name} (section 19.6.3).
\end{itemize}
}
\end{frame}

\begin{frame}[fragile,t]{4.7 - What Is Preserved, What We Ask}
\begin{itemize}
\setlength{\itemsep}{1pt}
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
...
\item \textcolor{blue!55!black}{\textbf{I would like to learn which explanations would help most in daily MML work. This leads to the next story: stronger proof search.}}
\end{itemize}
\smallskip
\textbf{Questions for later review:}
\begin{itemize}
...
\item \textcolor{blue!55!black}{\textbf{MizAR and MPTP already use ATP search with MML premises.}}
\item \textcolor{blue!55!black}{\textbf{Evo's goal is to keep proof checking small as search becomes stronger.}}
\item \textcolor{blue!55!black}{\textbf{A search result alone is not a kernel-verified proof. We need checkable evidence.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{We can read this diagram from left to right.}}
\item \textcolor{blue!55!black}{\textbf{Mizar-side phases resolve names, infer types, expand clusters, and pick overloads. ATPs do none of these tasks.}}
\item \textcolor{blue!55!black}{\textbf{The kernel checks the supplied formulas and substitutions, then runs its trusted SAT check. It does not select premises or invent substitutions.}}
\item \textcolor{blue!55!black}{\textbf{Earlier deterministic discharge also needs replayable evidence.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Here we can see what the evidence contains: source formulas, substitutions, provenance, and target and goal bindings.}}
\item \textcolor{blue!55!black}{\textbf{The kernel checks it, derives instantiated formulas and SAT clauses, and requires UNSAT from its trusted in-process Rust SAT checker.}}
\item \textcolor{blue!55!black}{\textbf{Backend resolution traces, SMT proof objects, logs, and exit codes are not trusted acceptance evidence.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The AI tool can propose a missing or more precise \texttt{by} reference.}}
\item This is a local edit that keeps the statement's meaning.
\item \textcolor{blue!55!black}{\textbf{The verifier checks it just as it would check a human edit.}}
...
\item \textcolor{blue!55!black}{\textbf{Now let us look at the cost of checking a large library.}}
\end{itemize}
\smallskip
\textbf{Questions for later review:}
\begin{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Checking the whole MML takes hours.}}
\item \textcolor{blue!55!black}{\textbf{The accepted article is the unit of reuse. A small edit can therefore cause more checking than we would like.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Evo uses fingerprints to decide when earlier results can be reused.}}
\item \textcolor{blue!55!black}{\textbf{All relevant cache keys must match. Missing data causes a cache miss.}}
\item \textcolor{blue!55!black}{\textbf{A proof-body edit does not rebuild importers when the exported statement and accepted status stay unchanged.}}
...
\begin{center}
\begin{beamercolorbox}[rounded=true,sep=2.5mm,wd=0.9\textwidth]{keyphrase}
\centering\itshape \textcolor{blue!55!black}{\textbf{Cache reuse is never proof authority.}}\\ \textcolor{blue!55!black}{\textbf{A clean build must reproduce every acceptance.}}
\end{beamercolorbox}
\end{center}
\note{
\smallskip
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Cache reuse is never proof authority.}} \textcolor{blue!55!black}{\textbf{A clean build must reproduce every acceptance.}}
\end{itemize}
}
\end{frame}
...
\item \textcolor{blue!55!black}{\textbf{We need tests that compare incremental results with a clean build.}}
\item \textcolor{blue!55!black}{\textbf{I would like to use real MML maintenance tasks for these tests. Next, I will turn to templates.}}
\end{itemize}
\smallskip
\textbf{Questions for later review:}
\begin{itemize}
...
\smallskip
\textbf{\textcolor{blue!55!black}{\textbf{This familiar scheme expresses induction}}}~\badgeMML
\begin{lstlisting}[language={mizar},basicstyle=\ttfamily\small]
scheme
...
\item \textcolor{blue!55!black}{\textbf{Classic \texttt{scheme} blocks define theorem schemas. Parameterized definitions use other language forms.}}
\item \textcolor{blue!55!black}{\textbf{Evo proposes a common template system for these tasks.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{This familiar scheme expresses induction}}.
\item Schemes support second-order patterns such as induction, separation, and replacement.
\item \textcolor{blue!55!black}{\textbf{Classic \texttt{scheme} blocks define theorem schemas. Parameterized definitions use other language forms.}}
\item \textcolor{blue!55!black}{\textbf{Evo proposes a common template system for these tasks.}}
\end{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Mizar already has parameterized constructions, such as \texttt{Polynom-Ring L}.}}
...
\smallskip
\textbf{\textcolor{blue!55!black}{\textbf{This template begins with a type parameter}}}~\badgeSpec
\begin{lstlisting}[language={mizar},basicstyle=\ttfamily\small]
definition
  let T be type;
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{A template is an ordinary \texttt{definition} block. Its leading \texttt{let} binds the parameters.}}
\item \textcolor{blue!55!black}{\textbf{Parameters can be types, values, predicates, or functors.}}
\item \textcolor{blue!55!black}{\textbf{Predicate and functor parameters cannot occur in \texttt{attr}, \texttt{mode}, \texttt{struct}, \texttt{func}, or \texttt{pred} items.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{This template begins with a type parameter}}.
\item \textcolor{blue!55!black}{\textbf{A template is an ordinary \texttt{definition} block. Its leading \texttt{let} binds the parameters.}}
\item \textcolor{blue!55!black}{\textbf{Parameters can be types, values, predicates, or functors.}}
\item \textcolor{blue!55!black}{\textbf{Predicate and functor parameters cannot occur in \texttt{attr}, \texttt{mode}, \texttt{struct}, \texttt{func}, or \texttt{pred} items.}}
\item Some templates allow short forms such as \texttt{Module over R} and \texttt{Subset of X}. Constrained templates require brackets.
...
\item \textcolor{blue!55!black}{\textbf{Each template body is checked once at declaration time. Each use checks the required constraints. Templates add no new logic.}}
\item \textcolor{blue!55!black}{\textbf{I would like to try this design on existing MML schemes. The next story connects proofs with algorithms.}}
\end{itemize}
\smallskip
\textbf{Questions for later review:}
\begin{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Mizar already provides arithmetic automation and proofs of program correctness.}}
\item \textcolor{blue!55!black}{\textbf{Evo proposes a language form for algorithms with contracts.}}
\item The goal is to connect verification, execution, and code extraction within one language and toolchain.
\item \textcolor{blue!55!black}{\textbf{Execution and code extraction are still planned work.}}
\end{itemize}
\smallskip
\textbf{Key Phrase:}
\begin{center}
...
\smallskip
\textbf{\textcolor{blue!55!black}{\textbf{This is Euclid's algorithm with a contract}}}~\badgeSpec
\begin{lstlisting}[language={mizar},basicstyle=\ttfamily\footnotesize]
definition
  let a, b be Nat;
...
\end{lstlisting}
The contract and invariant use mathematical \texttt{Gcd}, so there is no circular definition. \textcolor{blue!55!black}{\textbf{The loop computes the result. The \texttt{decreasing} measure on \texttt{y} proves termination.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{This is Euclid's algorithm with a contract}}.
\item The contract and invariant use mathematical \texttt{Gcd}, so there is no circular definition. \textcolor{blue!55!black}{\textbf{The loop computes the result. The \texttt{decreasing} measure on \texttt{y} proves termination.}}
\end{itemize}
\smallskip
\textbf{Optional notes and sources:}
\begin{itemize}
...
\smallskip
\textbf{\textcolor{blue!55!black}{\textbf{The specification allows proofs by computation}}}~\badgeSpec
\begin{lstlisting}[language={mizar},basicstyle=\ttfamily\small]
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The Mizar Virtual Machine, or MVM, evaluates ground equalities and predicates. Non-ground formulas need classical proofs.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The specification allows proofs by computation}}.
\item \textcolor{blue!55!black}{\textbf{The Mizar Virtual Machine, or MVM, evaluates ground equalities and predicates. Non-ground formulas need classical proofs.}}
\item Step, time, and depth limits are optional. Each defaults to zero, meaning unlimited.
\end{itemize}
}
...
\item \textcolor{blue!55!black}{\textbf{Verified promotion lets a \texttt{terminating} algorithm become a functor after its obligations are proved.}}
\item Proofs can also use \texttt{by computation} for computable ground calls in the current package.
\item \textcolor{blue!55!black}{\textbf{A partial algorithm's \texttt{ensures} requires evidence that the call terminates.}}
\item The first-order set-theoretic foundations stay the same.
\item \textcolor{blue!55!black}{\textbf{Now I will turn to how we publish and cite this work.}}
\end{itemize}
\smallskip
\textbf{Questions for later review:}
\begin{itemize}
...
\item \textcolor{blue!55!black}{\textbf{A journal article has an order that helps explain the mathematics. A reusable library needs an order based on dependencies.}}
\item \textcolor{blue!55!black}{\textbf{Changes to library organization can therefore affect links to published articles. Package reuse also lacks an identity for journal citations.}}
\item \textcolor{blue!55!black}{\textbf{Evo proposes separate, linked records for journal articles and library items.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{This sketch links citations, library items, verification artifacts, and MML origins.}}
\item \textcolor{blue!55!black}{\textbf{It shows links between records, not a derivation.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\item \textcolor{blue!55!black}{\textbf{Origin metadata would link migrated items to their MML citations. The migration mapping still needs to be defined.}}
\item I would like to discuss which identifiers readers should see in citations.
\item \textcolor{blue!55!black}{\textbf{That completes the eight stories. Let us now look at the whole design.}}
\end{itemize}
\smallskip
\textbf{Questions for later review:}
\begin{itemize}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{This diagram shows the ATP path through the proposed pipeline.}}
\item \textcolor{blue!55!black}{\textbf{Only obligations still open after deterministic discharge go to ATP. Earlier discharge also needs evidence.}}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Before I finish, let me separate the design from the implementation.}}
\item The specification has 24 chapters and appendices. English is canonical; Japanese companions are available.
\item \textcolor{blue!55!black}{\textbf{Implemented parts include frontend processing, selected semantic cases, ATP candidate generation, and kernel evidence checking.}}
\item \textcolor{blue!55!black}{\textbf{The full path from source through ATP and kernel checking to published artifacts is still in progress. Tests with real external provers are still needed.}}
\item \textcolor{blue!55!black}{\textbf{MVM execution, code extraction, and full MML migration remain future work.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{We plan an alpha at the end of 2026. It covers a core frontend subset, import and module resolution prototypes, diagnostics, and early artifacts.}}
\item \textcolor{blue!55!black}{\textbf{In 2027, we plan to translate three to five representative MML articles by hand and by script. We will record every mismatch.}}
\item In 2027 and 2028, we plan to expand from set and relation fragments to algebraic structures and their dependencies.
\item \textcolor{blue!55!black}{\textbf{The alpha does not aim at full MML verification, a final compatibility layer, or a stable AI protocol.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{I would like to finish with the question from the beginning.}}
\end{itemize}
\smallskip
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Which small MML articles should we migrate first?}}
\item \textcolor{blue!55!black}{\textbf{Which proposal needs the most change?}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{Mizar Evo should update the parts that need to support a larger library.}}
\item \textcolor{blue!55!black}{\textbf{It should keep the parts that define Mizar's mathematical identity.}}
\item \textcolor{blue!55!black}{\textbf{Thank you for listening. I would welcome your questions and comments.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
