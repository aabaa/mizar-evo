...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item Mizar Evo (specification example, §18.2.2; proof omitted):
\item The bound requires commutativity, associativity, and a unit.
\item Product[T] starts with the unit and folds the sequence with the selected operation. The library proves these defining equations.
\end{itemize}
After the example, explain which design obligation the syntax shows.
...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item A ring reaches Magma along two paths. qua selects the view. The view also sets the notation: the generic * appears as + for addition.
\item The required attributes must hold on the selected view.
\end{itemize}
After the example, explain which design obligation the syntax shows.
