...
\setlength{\parsep}{0pt}
\setlength{\parskip}{0pt}
\item \textcolor{blue!55!black}{\textbf{The Mizar Virtual Machine, or MVM, evaluates ground equalities and predicates. It uses computable algorithms defined in the current package. Non-ground formulas need classical proofs.}}
\item Step, time, and depth limits are optional. Each defaults to zero, meaning unlimited.
\item \textcolor{blue!55!black}{\textbf{Other packages' algorithm bodies cannot run here. Their \texttt{ensures} contracts can be used when termination is known.}}
\end{itemize}
\note{
\smallskip
\textbf{Read aloud:}
