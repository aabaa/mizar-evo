...
> [!NOTE]
> For ATP integration details and property encoding, see [Chapter 22 (Source Code Annotation and ATP Integration)](./22.source_code_annotation.md). Superposition-based provers (Vampire/E) typically treat unit equalities from reductions as rewrite rules without explicit instruction.
