...
- [11. 記号管理](#11-symbol-management)
  - [11.1 同義語と反意語](#111-synonyms-and-antonyms)
  - [11.2 範囲と可視性](#112-scope-and-visibility)
  - [11.3 インポート動作と競合解決](#113-import-behavior-and-conflict-resolution)
  - [11.4 パブリックシンボルとプライベートシンボル](#114-public-and-private-symbols)
  - [11.5 論理エンコーディングの詳細](#115-logic-encoding-details)
  - [11.6 完全な構文 (EBNF)](#116-complete-syntax-ebnf)

## 11.1 同義語と反意語

Mizar では、述語、関手、モード、属性の **同義語** と **反意語** を定義できます。これらは、意味上の同等性を維持しながら、代替表記を提供します。
