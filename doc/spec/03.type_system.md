...
* `mode_name`, `struct_name`, and `attribute_name` are identifiers; their defining chapters are Ch.7, Ch.5, and Ch.6 respectively.
...
mode_name         ::= identifier ;  (* See Chapter 7 for mode declarations *)
struct_name       ::= identifier ;  (* See Chapter 5 for struct declarations *)
