...
3. If a reserved identifier occurs free in a top-level theorem item (`theorem`
   or `lemma`, and any future theorem-role alias) or in a scheme declaration,
   and no local binding shadows it, that exported proposition is implicitly
