...
The unnamed witness form `take term_expression;` does not introduce a local name. Similarly, `reconsider term_expression as type_expression;` is a type-cast form and does not introduce a new local name.
