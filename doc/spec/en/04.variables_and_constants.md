...
3. If a reserved identifier occurs free in a theorem, lemma, scheme, or
   top-level proposition and no local binding shadows it, the proposition is
   implicitly universally closed over that identifier with the reserved type.
