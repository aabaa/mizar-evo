...
The original pattern may also be an application of a promoted `terminating`
algorithm (§20.7.2). The synonym then gives the algorithm mathematical notation
without a separate `func` definition:
