...
functor spelling by itself. The declared spelling must resolve to an already
declared or imported functor symbol at the point of the declaration. A later
`func` declaration with the same spelling is not a valid target for an earlier
