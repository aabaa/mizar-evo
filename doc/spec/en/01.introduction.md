...
5. **Substitution-Based Verification Kernel**:
    ...
    - **Minimal TCB**: The trusted kernel is strictly limited to the instantiation mechanism and a basic SAT solver, drastically reducing the Trusted Computing Base and making it safe to accept proofs proposed by AI.
