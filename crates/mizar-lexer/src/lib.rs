...
mod tests {
    use super::{
        ExportRank, ExportedSymbolShape, ImportPrescanDiagnosticCode, LexicalBlockKind,
        LexicalEnvironmentError, LexicalSummaryFingerprint, ModuleId, ModuleLexicalSummary,
        RESERVED_SYMBOLS, RESERVED_WORDS, RawModuleRelativePrefix, RawToken, RawTokenKind,
        ResolvedImport, ScopeLexView, ScopeSkeletonDiagnosticCode, SourceSpan, SymbolId, Token,
