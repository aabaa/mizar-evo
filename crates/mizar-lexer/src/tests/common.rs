pub(crate) use crate::{
    ...
    ModuleLexicalSummary, ModuleNamingError, ParserLexContext, RESERVED_SYMBOLS, RESERVED_WORDS,
    ...
    SourcePreprocessMapSegment, SourceSpan, SymbolId, Token, TokenKind, UserSymbolArity,
    UserSymbolCandidate, UserSymbolKind, UserSymbolKindSet, build_lexical_environment,
    build_scope_skeleton, disambiguate, is_identifier, is_layout, is_numeral, is_reserved_symbol,
