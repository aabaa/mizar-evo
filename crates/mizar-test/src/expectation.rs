...
pub(crate) const REQUIRED_SOUNDNESS_CASES: &[RequiredSoundnessCase] = &[
    ...
    RequiredSoundnessCase {
        key: "soundness.certificate.invalid_sat_refutation",
        domain: "certificate",
        expected_outcome: ExpectedOutcome::Fail,
        allowed_failure_categories: KERNEL_REJECTION_CATEGORY,
        allowed_rejection_reasons: &["invalid_sat_refutation"],
        allowed_stages: ADVANCED_STAGES,
        allowed_phases: CERTIFICATE_PHASES,
        requires_fast_profile: true,
    },
    RequiredSoundnessCase {
        key: "soundness.certificate.context_mismatch",
        domain: "certificate",
        expected_outcome: ExpectedOutcome::Fail,
        allowed_failure_categories: CERTIFICATE_OR_KERNEL_CATEGORIES,
        allowed_rejection_reasons: &["context_mismatch"],
        allowed_stages: ADVANCED_STAGES,
        allowed_phases: CERTIFICATE_PHASES,
        requires_fast_profile: true,
    },
    RequiredSoundnessCase {
        key: "soundness.certificate.missing_provenance",
        domain: "certificate",
        expected_outcome: ExpectedOutcome::Fail,
        allowed_failure_categories: KERNEL_REJECTION_CATEGORY,
        allowed_rejection_reasons: &["missing_provenance"],
        allowed_stages: ADVANCED_STAGES,
        allowed_phases: CERTIFICATE_PHASES,
        requires_fast_profile: true,
    },
    RequiredSoundnessCase {
        key: "soundness.certificate.unsupported_legacy_certificate",
        domain: "certificate",
        expected_outcome: ExpectedOutcome::Fail,
        allowed_failure_categories: &["certificate_rejection"],
        allowed_rejection_reasons: &["unsupported_certificate_format"],
        allowed_stages: ADVANCED_STAGES,
        allowed_phases: CERTIFICATE_PHASES,
        requires_fast_profile: true,
    },
