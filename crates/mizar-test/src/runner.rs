...
use mizar_checker::type_checker::{
    AttributePolarity, DeclarationCheckingOutput, DeclarationKind, DeclarationStatus,
    ExpectedTypeInput, FormulaDeferredReason, FormulaInput, FormulaKind, FormulaStatus,
    ModeExpansion, NormalizedTypeStatus, SourceReserveBindingInput, SourceReserveDeclarationBridge,
