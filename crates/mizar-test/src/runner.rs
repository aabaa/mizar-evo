...
use type_elaboration::{
    ...
    SOURCE_STATEMENT_B2_TEXT, SOURCE_STATEMENT_B3_TEXT, SOURCE_STATEMENT_B3N_TEXT,
    ...
    SourceStatementB2Extraction, SourceStatementB3Extraction, SourceStatementB3NExtraction,
    ...
    extract_named_witness_source_statement, extract_nested_source_statement,
