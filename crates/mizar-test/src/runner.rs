...
use type_elaboration::{
    ...
    SOURCE_STATEMENT_B2_TEXT, SOURCE_STATEMENT_B3_TEXT, SOURCE_STATEMENT_TEXT,
    ...
    SourceStatementB2Extraction, SourceStatementB3Extraction, SourceStatementB3RouteInputs,
    ...
    extract_builtin_source_reserve_declarations_after_node_guard, extract_nested_source_statement,
    ...
    source_statement_b3_resolver_env_for_test, source_statement_output_with_resolver_mutation,
