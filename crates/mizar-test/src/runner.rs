...
use type_elaboration::{
    ...
    SourceReservedVariableAssertedHeadRelation, SourceReservedVariableBinaryFormulaConfig,
    ...
    SourceTypeExpression, direct_token_texts, exact_identifier_term_operand,
