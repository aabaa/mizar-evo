...
use type_elaboration::{
    ...
    SOURCE_STATEMENT_B3M2B2B3B_TEXT, SOURCE_STATEMENT_B3N_TEXT, SOURCE_STATEMENT_TEXT,
    ...
    source_statement_b3m2b2b3b_resolver_env_for_test, source_statement_b3n_output_with_mutation,
