...
use type_elaboration::{
    ...
    source_local_mode_reserved_variable_membership_output, source_mode_symbol_spelling,
...
use type_elaboration::{
    ...
    source_local_mode_reserved_variable_membership_detail_keys, source_module_binding_env,
