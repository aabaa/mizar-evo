    use super::{
        ...
        SourceContradictionHandoffCorruption,
        assemble_source_contradiction_checker_handoff,
        extract_source_builtin_binary_term_formula,
        active_type_elaboration_cases, assemble_source_checker_handoff,
        assert_source_contradiction_handoff, assert_source_reserved_variable_formula_output,
