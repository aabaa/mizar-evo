...
use super::source_reserve::{
    SourceReserveExtraction, SourceTypeExpression,
...
#[derive(Debug)]
pub(in crate::runner) struct SourceReservedVariableBinaryFormula {
    pub(in crate::runner) reserve: SourceReserveExtraction,
    pub(in crate::runner) config: &'static SourceReservedVariableBinaryFormulaConfig,
    ...
    pub(in crate::runner) left_spelling: String,
    ...
    pub(in crate::runner) right_spelling: String,
    pub(in crate::runner) right_lookup_ordinal: usize,
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::runner) enum SourceParenthesizedOperandSide {
    Left,
    Right,
}

#[derive(Debug)]
pub(in crate::runner) struct SourceParenthesizedReservedVariableBinaryFormula {
    ...
    pub(in crate::runner) formula: SourceReservedVariableBinaryFormula,
}

#[derive(Debug)]
pub(in crate::runner) struct SourceReservedVariableTypeAssertion {
    pub(in crate::runner) reserve: SourceReserveExtraction,
    pub(in crate::runner) config: &'static SourceReservedVariableTypeAssertionConfig,
    pub(in crate::runner) formula_site: TypedSiteRef,
    pub(in crate::runner) formula_range: SourceRange,
    pub(in crate::runner) subject_site: TypedSiteRef,
    pub(in crate::runner) subject_range: SourceRange,
    pub(in crate::runner) subject_spelling: String,
    pub(in crate::runner) subject_lookup_ordinal: usize,
    pub(in crate::runner) asserted_type_site: TypedSiteRef,
    pub(in crate::runner) asserted_type: SourceTypeExpression,
}

pub(in crate::runner) fn extract_source_reserved_variable_binary_formula(
    ast: &SurfaceAst,
...
pub(in crate::runner) fn extract_source_parenthesized_reserved_variable_binary_formula_with_config(
    ast: &SurfaceAst,
    module: ResolverModuleId,
    symbols: &SymbolEnv,
    config: &'static SourceReservedVariableBinaryFormulaConfig,
...
pub(in crate::runner) fn extract_source_reserved_variable_type_assertion_with_config(
    ast: &SurfaceAst,
    module: ResolverModuleId,
    symbols: &SymbolEnv,
...
#[derive(Debug, Clone)]
pub(in crate::runner) struct SourceFormulaQuantifierBoundUse {
    pub(in crate::runner) quantified_site: TypedSiteRef,
    pub(in crate::runner) quantified_range: SourceRange,
    pub(in crate::runner) binder_segment_site: TypedSiteRef,
    pub(in crate::runner) binder_segment_range: SourceRange,
    ...
    pub(in crate::runner) binder_type_head_site: TypedSiteRef,
    pub(in crate::runner) binder_type_head_range: SourceRange,
    pub(in crate::runner) equality_site: TypedSiteRef,
    pub(in crate::runner) equality_range: SourceRange,
    pub(in crate::runner) left_site: TypedSiteRef,
    pub(in crate::runner) left_range: SourceRange,
    pub(in crate::runner) right_site: TypedSiteRef,
    pub(in crate::runner) right_range: SourceRange,
...
pub(in crate::runner) fn extract_source_formula_quantifier_bound_use(
    ast: &SurfaceAst,
    module: &ResolverModuleId,
    symbols: &SymbolEnv,
) -> Option<SourceFormulaQuantifierBoundUse> {
    if ast
        .nodes()
        .iter()
        .any(|node| !is_supported_formula_quantifier_bound_use_theorem_bridge_node(node))
    {
        return None;
    }
    let theorem_items = surface_nodes_with_kind(ast, SurfaceNodeKind::TheoremItem);
    ...
    let quantified_children = structural_child_ids(ast, quantified);
    let [segment_id, equality_id] = quantified_children.as_slice() else {
        return None;
    };
    ...
    let (right_id, right_range, right_spelling) =
        exact_identifier_term_operand(ast, *right_expression_id)?;
    if left_id == right_id || left_spelling != "x" || right_spelling != "x" {
        return None;
    }

    Some(SourceFormulaQuantifierBoundUse {
        quantified_site: surface_site(*quantified_id),
        quantified_range: quantified.range,
        binder_segment_site: surface_site(*segment_id),
        binder_segment_range: segment.range,
        ...
        binder_type_head_site: surface_site(*type_head_id),
        binder_type_head_range: type_head.range,
        equality_site: surface_site(*equality_id),
        equality_range: equality.range,
        left_site: surface_site(left_id),
        left_range,
        right_site: surface_site(right_id),
        right_range,
...
fn is_supported_formula_quantifier_bound_use_theorem_bridge_node(node: &SurfaceNode) -> bool {
    matches!(
        node.kind,
        SurfaceNodeKind::Root
            | SurfaceNodeKind::CompilationUnit
