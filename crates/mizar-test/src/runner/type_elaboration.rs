...
mod source_proof_local_declaration;
...
pub(super) use source_proof_local_declaration::{
    ...
    SourceProofLocalGivenUseBindingRouteMutation, SourceProofLocalGivenUseTypeRouteMutation,
    SourceProofLocalGivenUseTypeRouteOutput, SourceProofLocalLetBindingRouteMutation,
    SourceProofLocalLetBindingRouteOutput, SourceProofLocalLetTypeRouteMutation,
    SourceProofLocalLetTypeRouteOutput, source_proof_local_declaration_output,
    source_proof_local_declaration_output_with_mutation, source_proof_local_given_binding_output,
    source_proof_local_given_binding_output_with_mutation, source_proof_local_given_type_output,
...
pub(super) use source_statement::{
    ...
    SOURCE_STATEMENT_B4B_TEXT, SOURCE_STATEMENT_B4C_TEXT, SOURCE_STATEMENT_B5A_TEXT,
    SOURCE_STATEMENT_TEXT, SourceProofLocalGivenLowerMutation, SourceProofLocalGivenLowerOutput,
    SourceProofLocalGivenResolverProfileMutation, SourceProofLocalGivenShellMutation,
    SourceProofLocalGivenSurfaceMutation, SourceProofLocalGivenUseLowerMutation,
    ...
    SourceProofLocalLetSurfaceMutation, SourceStatementB1Extraction, SourceStatementB2Extraction,
    ...
    extract_wrapped_application_witness_source_statement, source_proof_local_given_lower_output,
    ...
    source_statement_b3_output_with_resolver_mutation, source_statement_b3_resolver_env_for_test,
    source_statement_b3m1_output_with_mutation,
