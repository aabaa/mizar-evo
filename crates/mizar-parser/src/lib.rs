...
mod tests {
    ...
    fn quantifier_for_does_not_open_recovery_block() {
        ...
        let tokens = vec![
            ...
            token(source_id, ParserTokenKind::ReservedWord, "pred", 11, 15),
            token(source_id, ParserTokenKind::Identifier, "P", 16, 17),
            token(source_id, ParserTokenKind::ReservedSymbol, ":", 18, 19),
            token(source_id, ParserTokenKind::Identifier, "R", 20, 21),
            token(source_id, ParserTokenKind::ReservedWord, "means", 22, 27),
            token(source_id, ParserTokenKind::ReservedWord, "for", 28, 31),
            token(source_id, ParserTokenKind::Identifier, "x", 32, 33),
            token(source_id, ParserTokenKind::ReservedWord, "being", 34, 39),
            token(source_id, ParserTokenKind::ReservedWord, "set", 40, 43),
            token(source_id, ParserTokenKind::ReservedWord, "holds", 44, 49),
            token(source_id, ParserTokenKind::ReservedWord, "thesis", 50, 56),
            token(source_id, ParserTokenKind::ReservedSymbol, ";", 56, 57),
            token(source_id, ParserTokenKind::ReservedWord, "end", 58, 61),
            token(source_id, ParserTokenKind::ReservedSymbol, ";", 61, 62),
        ];
