...
mod tests {
    ...
    fn quantifier_for_does_not_open_recovery_block() {
        ...
        let tokens = vec![
            ...
            token(source_id, ParserTokenKind::ReservedWord, "means", 18, 23),
            token(source_id, ParserTokenKind::ReservedWord, "for", 24, 27),
            token(source_id, ParserTokenKind::Identifier, "x", 28, 29),
            token(source_id, ParserTokenKind::ReservedWord, "being", 30, 35),
            token(source_id, ParserTokenKind::Identifier, "Nat", 36, 39),
            token(source_id, ParserTokenKind::ReservedWord, "holds", 40, 45),
            token(source_id, ParserTokenKind::ReservedWord, "end", 46, 49),
            token(source_id, ParserTokenKind::ReservedSymbol, ";", 49, 50),
        ];
