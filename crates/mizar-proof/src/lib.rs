...
//! values whose status is accepted and whose evidence check kind is a proof
//! obligation. Backend proof methods, resolution traces, SMT proof objects,
//! backend logs, externally attested records, diagnostics, accepted
//! consistency checks, and cache records are not promoted into trusted proof status
//! or trusted `used_axioms`.
