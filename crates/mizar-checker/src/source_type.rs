...
use crate::{
    ...
    source_proof_local_declaration::{
        SourceProofLocalGivenBindingHandoff, SourceProofLocalGivenUseBindingHandoff,
...
mod tests {
    ...
    use crate::{
        ...
        source_proof_local_declaration::{
            ...
            SourceProofLocalGivenBindingRecovery, SourceProofLocalGivenUseBindingHandoffInput,
